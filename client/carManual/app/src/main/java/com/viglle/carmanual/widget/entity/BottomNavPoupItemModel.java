 ...
 */
public class BottomNavPoupItemModel {
    ...
    private List<ItemModel> subMenu=new ArrayList<>();
    ...
    public List<ItemModel> getSubMenu() {
        return subMenu;
    }

    public void setSubMenu(List<ItemModel> submenu) {
